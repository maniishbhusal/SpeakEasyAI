...
function PricingSection() {
    ...
    const shimmer = {
        animate: {
            background: ['hsla(210, 100%, 86%, 0)', 'hsla(210, 100%, 86%, 0.2)', 'hsla(210, 100%, 86%, 0)'],
            transition: {
                duration: 2.5,
                repeat: Infinity,
                repeatType: "reverse"
    ...
    return (
        <section className="bg-gradient-to-b from-[#F8F9FA] to-[#F0F4F8]" id="pricing">
            <MaxWidthWrapper className='py-24'>
                ...
                >
                    ...
                    >
                        ...
                        <p className='text-primary text-xs font-semibold tracking-wide'>PRICING PLANS</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-[#6B7989] text-lg">
                            Flexible pricing options designed to scale with your business and deliver exceptional value at every level.
                        </p>
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <ul className="text-left text-[#6B7989] font-medium space-y-4 mb-8">
                            ...
                            >
                                <CircleCheck className="h-5 w-5 shrink-0 fill-[#39BAF6] text-white" />
                                <span className="font-bold text-[#293A51]">Custom</span> integrations
                            </motion.li>
                            <motion.li 
                                className="flex gap-1.5 items-center text-left"
                                initial={{ opacity: 0, x: -10 }}
                ...
                >
                    <div className="flex items-center space-x-4 mb-4 md:mb-0">
                        ...
                        <div>
                            <h4 className="font-bold text-[#293A51]">30-Day Money-Back Guarantee</h4>
                            <p className="text-[#6B7989]">Try risk-free with our no-questions-asked refund policy</p>
                        </div>
                    </div>
                    <motion.button
